...
In this exercise use the example code in this code pen: [Animation example](https://codepen.io/marenpg/pen/wvwVPZV)
Solution can be found here: [Animation solution](https://codepen.io/marenpg/pen/NWKQwVW)
